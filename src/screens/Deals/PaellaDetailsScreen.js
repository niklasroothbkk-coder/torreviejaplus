...
export default function PaellaDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../../assets/deals/Paella.png')} 
        ...
        <View style={styles.contentCard}>
          <Text style={styles.dealTitle}>Paella Day</Text>
          
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              <Ionicons name="location" size={16} color="#0077B6" />
              <Text style={styles.infoText}>Restaurante Mar</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="star" size={16} color="#0077B6" />
              <Text style={styles.infoText}>4.4 (78 Reviews)</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="calendar" size={16} color="#0077B6" />
              <Text style={styles.infoText}>2025-12-10 (18:00)</Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Join us for our famous Paella Day! Experience authentic Valencian paella prepared fresh with seafood, chicken, and traditional Spanish rice.{'\n\n'}
              This Tuesday, December 10th at 18:00. Price includes paella, bread, and a glass of sangria. Vegetarian option available. Reservations required.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>4.4 (78 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Isabella Rodriguez</Text>
                    <Text style={styles.reviewDate}>Nov 12, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
                  <Text style={styles.reviewRatingText}>4.6</Text>
                </View>
              </View>
              <Text style={styles.reviewText}>
                The best paella I've had outside of Valencia! Generous portions and authentic flavors. The sangria was perfect too!
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Carlos Martinez</Text>
                    <Text style={styles.reviewDate}>Oct 28, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
              ...
              <Text style={styles.reviewText}>
                Excellent seafood paella with a beautiful sea view. Great value for the price and the atmosphere is wonderful.
              </Text>
            </View>
