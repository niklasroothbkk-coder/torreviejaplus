...
export default function JetskiDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../../assets/deals/Jetski.png')} 
        ...
        <View style={styles.contentCard}>
          <Text style={styles.dealTitle}>Jetski Adventure</Text>
          
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              <Ionicons name="location" size={16} color="#0077B6" />
              <Text style={styles.infoText}>Beach Sports Center</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="star" size={16} color="#0077B6" />
              <Text style={styles.infoText}>4.0 (45 Reviews)</Text>
            </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Experience the thrill of jet skiing on the beautiful Mediterranean Sea! Special December offer - Only €10 for 30 minutes of adrenaline-pumping fun.{'\n\n'}
              Available daily throughout December (weather permitting). All safety equipment included. No experience necessary - full instruction provided. Minimum age 16.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>4.0 (45 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Alex Turner</Text>
                    <Text style={styles.reviewDate}>Nov 18, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
                  <Text style={styles.reviewRatingText}>4.2</Text>
                </View>
              </View>
              <Text style={styles.reviewText}>
                Amazing experience! The instructors were professional and made sure everyone felt safe. The views from the water are incredible!
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Lisa Anderson</Text>
                    <Text style={styles.reviewDate}>Oct 30, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
              ...
              <Text style={styles.reviewText}>
                So much fun! Great value for money at this price. Perfect activity for an adrenaline rush. Will definitely come back!
              </Text>
            </View>
      ...
      <View style={styles.bottomBar}>
        <View style={styles.priceContainer}>
          ...
          <Text style={styles.perPerson}>/30 min</Text>
        </View>
