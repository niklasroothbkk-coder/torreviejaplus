...
export default function TapasDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../../assets/deals/Tapas.png')} 
        ...
        <View style={styles.contentCard}>
          <Text style={styles.dealTitle}>Tapas Night</Text>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>4.4 (85 Reviews)</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="calendar" size={16} color="#0077B6" />
              <Text style={styles.infoText}>2025-12-11 (19:00)</Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Experience authentic Spanish tapas night! Enjoy a selection of 5 traditional tapas including patatas bravas, gambas al ajillo, jamón ibérico, croquetas, and Spanish tortilla.{'\n\n'}
              Wednesday, December 11th at 19:00. Includes a glass of Spanish wine or beer. Perfect for sharing with friends!
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>4.4 (85 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Miguel Santos</Text>
                    <Text style={styles.reviewDate}>Nov 8, 2024</Text>
                  </View>
                </View>
              ...
              <Text style={styles.reviewText}>
                Authentic Spanish tapas in a cozy atmosphere. The jamón ibérico was exceptional and the wine selection is excellent!
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Ana Garcia</Text>
                    <Text style={styles.reviewDate}>Oct 22, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
              ...
              <Text style={styles.reviewText}>
                Great variety of tapas and generous portions. Perfect for a night out with friends. The patatas bravas are a must-try!
              </Text>
            </View>
