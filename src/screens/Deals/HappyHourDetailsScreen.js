...
export default function HappyHourDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../../assets/deals/HH.png')} 
        ...
        <View style={styles.contentCard}>
          <Text style={styles.dealTitle}>Happy Hour</Text>
          
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              <Ionicons name="location" size={16} color="#0077B6" />
              <Text style={styles.infoText}>Bar Estrella</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="star" size={16} color="#0077B6" />
              <Text style={styles.infoText}>4.3 (65 Reviews)</Text>
            </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Throughout December, enjoy our special Happy Hour promotion! Buy one drink and get one free every day from 17:00 to 19:00.{'\n\n'}
              Valid for all beers, wines, and selected cocktails. Come early to secure your spot at our popular beach-front bar!
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>4.3 (65 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Marcus Johnson</Text>
                    <Text style={styles.reviewDate}>Nov 28, 2024</Text>
                  </View>
                </View>
              ...
              <Text style={styles.reviewText}>
                Best happy hour deal in Torrevieja! Great atmosphere and the beachfront location is perfect for sunset drinks.
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Emma Williams</Text>
                    <Text style={styles.reviewDate}>Nov 15, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
              ...
              <Text style={styles.reviewText}>
                Fantastic value! The cocktails are well-made and the staff is friendly. Gets busy quickly, so arrive early.
              </Text>
            </View>
      ...
      <View style={styles.bottomBar}>
        <View style={styles.priceContainer}>
          <Text style={styles.price}>Buy 1 Get 1</Text>
        </View>
