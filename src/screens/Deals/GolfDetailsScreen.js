...
export default function GolfDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../../assets/deals/Golf.png')} 
        ...
        <View style={styles.contentCard}>
          <Text style={styles.dealTitle}>Golf Special</Text>
          
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              <Ionicons name="location" size={16} color="#0077B6" />
              <Text style={styles.infoText}>Golf Club Torrevieja</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="star" size={16} color="#0077B6" />
              <Text style={styles.infoText}>4.1 (52 Reviews)</Text>
            </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Special December offer - Get 50% off on all green fees throughout the month (weekdays)! Valid Monday to Friday.{'\n\n'}
              Enjoy our championship 18-hole course with stunning Mediterranean views. Equipment rental available at discounted rates. Book your tee time today!
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>4.1 (52 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>David Thompson</Text>
              ...
              <Text style={styles.reviewText}>
                Excellent course with challenging holes and beautiful scenery. The staff is professional and the facilities are top-notch.
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Sarah Peterson</Text>
                    <Text style={styles.reviewDate}>Oct 5, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
              ...
              <Text style={styles.reviewText}>
                Great value for money with this deal! The course is well-maintained and the views are spectacular.
              </Text>
            </View>
      ...
      <View style={styles.bottomBar}>
        <View style={styles.priceContainer}>
          <Text style={styles.price}>50% off</Text>
        </View>
