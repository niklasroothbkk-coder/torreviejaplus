...
export default function NightClubDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../../assets/events/candy-photo.png')} 
        ...
        <View style={styles.contentCard}>
          <Text style={styles.eventTitle}>Night Club Event</Text>
          
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              <Ionicons name="location" size={16} color="#0077B6" />
              <Text style={styles.infoText}>Club Elite</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="star" size={16} color="#0077B6" />
              <Text style={styles.infoText}>3.9 (73 Reviews)</Text>
            </View>
          </View>
          ...
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>2025-12-11 (22:00)</Text>
            </View>
          </View>
          ...
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>€15:00 /person</Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Join the hottest night club event in Torrevieja! International DJs, spectacular light shows, and an unforgettable party atmosphere await you.{'\n\n'}
              Wednesday, December 11th from 22:00 until late. Entry includes one welcome drink. Dress code: Smart casual. Must be 18+. Pre-booking recommended for VIP tables.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>3.9 (73 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Jessica Taylor</Text>
                    <Text style={styles.reviewDate}>Nov 16, 2024</Text>
                  </View>
                </View>
              ...
              <Text style={styles.reviewText}>
                Great club with amazing music and atmosphere! The DJs know how to keep the crowd energized. Perfect night out!
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Ryan Mitchell</Text>
                    <Text style={styles.reviewDate}>Oct 29, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
                  <Text style={styles.reviewRatingText}>3.8</Text>
                </View>
              </View>
              <Text style={styles.reviewText}>
                Fun venue with good music selection. Can get crowded on weekends but that's part of the experience. Recommend arriving early!
              </Text>
            </View>
