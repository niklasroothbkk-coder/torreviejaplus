...
export default function HappyHourEventDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../../assets/events/happy-hour-photo.png')} 
        ...
        <View style={styles.contentCard}>
          <Text style={styles.eventTitle}>Get 2 Pay 1</Text>
          
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              <Ionicons name="location" size={16} color="#0077B6" />
              <Text style={styles.infoText}>La Tasca</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="star" size={16} color="#0077B6" />
              <Text style={styles.infoText}>3.7 (48 Reviews)</Text>
            </View>
          </View>
          ...
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>Whole December</Text>
            </View>
          </View>
          ...
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>€3:00 /drink</Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Amazing offer throughout December at La Tasca! Get 2 drinks for the price of 1 every evening from 18:00 to 20:00.{'\n\n'}
              Valid for all beers, wines, sangrias, and soft drinks. Perfect way to start your evening out in Torrevieja. No reservation needed, just drop by!
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>3.7 (48 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Tom Harrison</Text>
                    <Text style={styles.reviewDate}>Nov 14, 2024</Text>
                  </View>
                </View>
              ...
              <Text style={styles.reviewText}>
                Great value happy hour! The drinks are good quality and the location is convenient. Can get crowded during peak hours.
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Anna Nilsson</Text>
                    <Text style={styles.reviewDate}>Oct 27, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
                  <Text style={styles.reviewRatingText}>3.6</Text>
                </View>
              </View>
              <Text style={styles.reviewText}>
                Nice place for an affordable drink. The 2-for-1 deal is excellent and the staff is friendly. Good spot to meet up with friends!
              </Text>
            </View>
