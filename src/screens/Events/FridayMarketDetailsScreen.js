...
export default function FridayMarketDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contentCard}>
          <Text style={styles.eventTitle}>Friday Market</Text>
          
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              <Ionicons name="location" size={16} color="#0077B6" />
              <Text style={styles.infoText}>Plaza Antonio X</Text>
            </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Experience the vibrant Friday Market at Plaza Antonio X! Browse through stalls offering fresh local produce, artisanal crafts, clothing, and traditional Spanish delicacies.{'\n\n'}
              Every Friday from 10:00 to 14:00. Free entry. Perfect for families and anyone looking to experience authentic local culture. Don't miss the paella cooking demonstrations!
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>4.3 (92 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  <View>
                    ...
                    <Text style={styles.reviewDate}>Nov 22, 2024</Text>
                  </View>
                </View>
              ...
              <Text style={styles.reviewText}>
                Love this market! Great variety of fresh produce and local products. The atmosphere is fantastic and prices are reasonable.
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Peter Johnson</Text>
              ...
              <Text style={styles.reviewText}>
                A must-visit for anyone in Torrevieja! Great local crafts and the food stalls are amazing. Gets busy but worth it!
              </Text>
            </View>
