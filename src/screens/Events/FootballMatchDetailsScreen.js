...
export default function FootballMatchDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../../assets/events/fotball-photo.png')} 
        ...
        <View style={styles.contentCard}>
          <Text style={styles.eventTitle}>Spain vs Sweden</Text>
          
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              <Ionicons name="location" size={16} color="#0077B6" />
              <Text style={styles.infoText}>Plaza Elit</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="star" size={16} color="#0077B6" />
              <Text style={styles.infoText}>5.0 (127 Reviews)</Text>
            </View>
            
            <View style={styles.infoItem}>
              <Ionicons name="calendar" size={16} color="#0077B6" />
              <Text style={styles.infoText}>2025-12-09 (16:00)</Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Watch the exciting football match between Spain and Sweden on the big screen at Plaza Elit! Join fellow football fans for an unforgettable viewing experience.{'\n\n'}
              Monday, December 9th at 16:00. Free entry with giant outdoor screen, great atmosphere, and drink specials during the match. Arrive early to secure the best viewing spots!
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>5.0 (127 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Erik Svensson</Text>
                    <Text style={styles.reviewDate}>Nov 20, 2024</Text>
                  </View>
                </View>
              ...
              <Text style={styles.reviewText}>
                Amazing atmosphere! Perfect place to watch the match with other fans. The big screen and sound system are excellent!
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Carmen Rodriguez</Text>
                    <Text style={styles.reviewDate}>Nov 5, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
              ...
              <Text style={styles.reviewText}>
                Best place in Torrevieja to watch football! Great crowd, free entry, and the drink specials are fantastic. Highly recommend!
              </Text>
            </View>
