...
export default function WineTastingDetailsScreen({ onNavigate }) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../../assets/events/Wine.png')} 
        ...
        <View style={styles.contentCard}>
          <Text style={styles.eventTitle}>Wine Tasting</Text>
          
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              <Ionicons name="location" size={16} color="#0077B6" />
              <Text style={styles.infoText}>WineGuro</Text>
            </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.detailsText}>
              Join us for an exquisite wine tasting experience! Discover the finest Spanish wines from renowned regions including Rioja, Ribera del Duero, and Priorat.{'\n\n'}
              Monday, December 9th at 14:00. Sample 6 premium wines paired with artisanal cheeses and charcuterie. Our sommelier will guide you through each tasting. Limited seats available - book now!
            </Text>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.reviewsMainHeader}>
              ...
              <View style={styles.ratingBadge}>
                ...
                <Text style={styles.ratingText}>4.0 (55 Reviews)</Text>
              </View>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>Sophie Laurent</Text>
                    <Text style={styles.reviewDate}>Nov 25, 2024</Text>
                  </View>
                </View>
              ...
              <Text style={styles.reviewText}>
                Wonderful selection of wines! The sommelier was knowledgeable and the pairings were perfect. A must-do for wine lovers!
              </Text>
            </View>
            ...
            <View style={styles.reviewCard}>
              <View style={styles.reviewHeader}>
                <View style={styles.reviewerInfo}>
                  ...
                  />
                  <View>
                    <Text style={styles.reviewerName}>James Anderson</Text>
                    <Text style={styles.reviewDate}>Nov 10, 2024</Text>
                  </View>
                </View>
                <View style={styles.reviewRating}>
                  <Ionicons name="star" size={14} color="#0077B6" />
              ...
              <Text style={styles.reviewText}>
                Great experience with high-quality wines. The atmosphere was elegant and the staff very professional. Highly recommended!
              </Text>
            </View>
